...
#[derive(Serialize, Deserialize, Debug, PartialEq)]
#[allow(non_snake_case)]
pub struct HKLMValve { pub Steam: HKLMSteam, }

#[derive(Serialize, Deserialize, Debug, PartialEq)]
#[allow(non_snake_case)]
pub struct HKLMSoftware { pub Valve: HKLMValve, }

#[derive(Serialize, Deserialize, Debug, PartialEq)]
#[allow(non_snake_case)]
pub struct HKLM { pub Software: HKLMSoftware, }
...
#[derive(Serialize, Deserialize, Debug, PartialEq)]
#[allow(non_snake_case)]
pub struct HKCUSteamGlobal { pub language: String }
...
#[derive(Serialize, Deserialize, Debug, PartialEq)]
#[allow(non_snake_case)]
pub struct HKCUValve { pub Steam: HKCUSteam, }

#[derive(Serialize, Deserialize, Debug, PartialEq)]
#[allow(non_snake_case)]
pub struct HKCUSoftware { pub Valve: HKCUValve, }

#[derive(Serialize, Deserialize, Debug, PartialEq)]
#[allow(non_snake_case)]
pub struct HKCU { pub Software: HKCUSoftware, }

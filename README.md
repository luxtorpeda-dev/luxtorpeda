...
Luxtorpeda transforms Windows games into native Linux titles, offering improved performance, fewer bugs, and sometimes even enhanced graphics and modern features.
...
Setting up Luxtorpeda is a breeze – simply force your game to use Luxtorpeda through Steam's interface. Once configured, Luxtorpeda seamlessly handles the rest, ensuring a smooth gaming experience with minimal effort on your part. It's like having a dedicated Linux gaming companion that takes care of the technicalities, leaving you to immerse yourself in the gaming world.

![screenshot-0](https://user-images.githubusercontent.com/3967/61964568-7b674500-afce-11e9-9c42-ef6cc1b425b6.png)

Discover the future of Linux gaming with Luxtorpeda – your gateway to an elevated, open-source gaming universe.

### ✅ Supported Games

**[Supported Games Webpage](https://luxtorpeda-dev.github.io)**: check out our supported games on our webpage.

**[Supported Games Steam curator](https://store.steampowered.com/curator/41650678/)**: check out our supported games on our Steam curator page.
...
### 💻 On Linux
1. [Download and install ProtonUp-Qt](https://davidotek.github.io/protonup-qt/#download).
...
There's two easy ways to install Luxtorpeda on Steam Deck. You can either install it from Desktop Mode or if you're using [Decky Loader](https://decky.xyz/) you can install it using the [Wine Cellar](https://github.com/FlashyReese/decky-wine-cellar) plugin.

#### From Desktop mode
1. From the STEAM menu, select Power, then Switch to Desktop.
2. Open the 'Discover Store'.
3. Search and download 'ProtonUp-Qt'.
4. Follow the same steps as [installation On Linux](#-on-linux) above.
5. On the desktop, there's a link to 'Return to Gaming Mode'. Select that to get back to standard Steam Deck UI. You can also go through the system menus to Log Off to get back.

#### From Decky Loader
1. Download and [install Decky Loader]([https://decky.xyz/)](https://github.com/SteamDeckHomebrew/decky-loader?tab=readme-ov-file#-installation).
2. Download the 'Wine Cellar' plugin using [these instructions](https://github.com/SteamDeckHomebrew/decky-loader?tab=readme-ov-file#-getting-started).
3. Go to the Decky Loader tab on the Quick Access menu and find the Wine Cellar plugin.
4. Oress "Manage" to get taken to a new screen:
5. Choose 'Luxtorpeda' from the menu and install it.
6. Restart Steam
7. In Steam game properties window select "Force the use of a specific Steam Play compatibility tool" and select "Luxtorpeda".

For further installation methods, see our [Other installation methods](#other-installation-methods) section.

## 💬 Join the Community
Need help? have questions? want to chat about fun old games? We are a welcoming community to all. 

**[Discord channel](https://discord.gg/8mFhUPX)**: welcome to our Discord channel

**[Steam Group](https://steamcommunity.com/groups/luxtorpedaplay)**: join our Steam group.
